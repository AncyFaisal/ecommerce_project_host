...
from apps.products.views import category_add, category_manage, category_edit, category_success, category_filter, category_delete
from apps.products.views import *  # REMOVED product_delete
from apps.accounts.views import *
from apps.products.views import homeproduct
from apps.accounts.views import *
...
from apps.analytics.views import sales_report, export_sales_report
...
from apps.wallet.views import admin_pending_refunds, admin_approve_refund, admin_reject_refund,admin_wallet_transactions, admin_wallet_transaction_detail, admin_user_wallet
from apps.coupons.views import (
...
from apps.reviews.views import add_review
# from apps.orders.views import order_list, order_detail, cancel_order, cancel_order_item, return_order, download_invoice
...
path('products/<int:product_pk>/variants/<int:variant_pk>/restore/', variant_restore, name='variant_restore'), 
    ...
    path('wishlist/get-item-id/<int:variant_id>/', get_wishlist_item_id, name='get_wishlist_item_id'),
    path('wishlist/check/<int:variant_id>/', check_wishlist_status, name='check_wishlist_status'),
    path('wishlist/count/', get_wishlist_count, name='get_wishlist_count'),
    path('wishlist/', wishlist_view, name='wishlist'),
    path('wishlist/add/<int:variant_id>/', add_to_wishlist, name='add_to_wishlist'),
    path('wishlist/remove/<int:variant_id>/', remove_from_wishlist, name='remove_from_wishlist'),
    path('wishlist/move-to-cart/<int:variant_id>/', add_to_cart_from_wishlist, name='move_to_cart_from_wishlist'),
...
path('coupons/<int:coupon_id>/view/', view_coupon, name='view_coupon'),
path('coupons/<int:coupon_id>/edit/', edit_coupon, name='edit_coupon'),
